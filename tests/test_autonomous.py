...
class TestEvaluation:
    ...
    def test_survive_on_threat(self, autonomous):
        ...
        action, params = autonomous._evaluate(state)
        assert action == AutonomousLoop.ACTION_SURVIVE
        assert params["reason"] == "threat_nearby"
    
    def test_survive_on_low_health(self, autonomous):
    ...
    def test_explore_when_idle(self, autonomous):
