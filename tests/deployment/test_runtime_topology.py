...
def test_compose_services_inject_only_explicit_least_privilege_environment() -> None:
    ...
    assert set(app["environment"]) == {
        ...
        "ANIMETTA_AUTH_USERNAME=${ANIMETTA_AUTH_USERNAME:?ANIMETTA_AUTH_USERNAME is required}",
        "ANIMETTA_AUTH_PASSWORD_HASH=${ANIMETTA_AUTH_PASSWORD_HASH:?ANIMETTA_AUTH_PASSWORD_HASH is required}",
