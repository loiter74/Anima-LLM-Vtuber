...
export const MAO_PERFORMANCE_OWNED_PARAMETERS = Object.freeze(
...
export function resolveMaoPerformanceParameters(
  ...
  return MAO_PERFORMANCE_OWNED_PARAMETERS.flatMap((name) => {
...
export const MAO_PERFORMANCE_PROFILE: Live2DPerformanceProfile = Object.freeze({
  resolve: resolveMaoPerformanceParameters,
})
