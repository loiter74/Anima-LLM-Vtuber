#!/usr/bin/env python3
"""Run OpenCode analysis for danmaku.

This script reads danmaku from CSV, analyzes with mimo and glm models
using OpenCode's task system, and merges results.

Usage:
    python scripts/run_opencode_analysis.py --input data/training/danmaku_analyzed.csv --output data/training/danmaku_final.csv
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Run OpenCode analysis for danmaku",
    )
