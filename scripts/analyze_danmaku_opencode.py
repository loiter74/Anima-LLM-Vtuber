...
Usage:
    python scripts/analyze_danmaku_opencode.py --input data/training/danmaku_analyzed.csv --output data/training/danmaku_final.csv
"""
...
def parse_batch_response(response: str, batch_size: int) -> list[dict]:
    ...
    try:
        ...
        while len(results) < batch_size:
            results.append({"context": "分析失败", "humor_type": "其他"})
