"""Content-free runtime readiness snapshots owned by the application runtime.
...
def unwrap_tracing_proxy(engine: Any) -> Any:
    """Compatibility name for the neutral service-proxy helper."""
    return unwrap_service_proxy(engine)
