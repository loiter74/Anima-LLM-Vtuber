...
import { normalizeResourceName, getResourceDefinition, REGISTRY, isUndergroundCategory } from './registry.js';
...
// 元数据完整性（T3.3）
assert(Object.keys(REGISTRY).length === 7, '7 canonical resources');
