#!/usr/bin/env node
/**
 * Full Workflow: Make wooden pickaxe → Mine stone → Craft stone weapons
 */
...
bot.on('spawn', async () => {
  ...
  console.log('\n=== Full Workflow: Wooden Pickaxe → Stone Weapons ===\n');
  ...
  // Step 4: Mine stone with pickaxe
